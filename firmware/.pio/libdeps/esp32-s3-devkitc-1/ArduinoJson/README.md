...
[![Arduino Library Manager](https://img.shields.io/static/v1?label=Arduino&message=v6.21.6&logo=arduino&logoColor=white&color=blue)](https://www.ardu-badge.com/ArduinoJson/6.21.6)
[![PlatformIO Registry](https://badges.registry.platformio.org/packages/bblanchon/library/ArduinoJson.svg?version=6.21.6)](https://registry.platformio.org/packages/libraries/bblanchon/ArduinoJson?version=6.21.6) 
[![ESP IDF](https://img.shields.io/static/v1?label=ESP+IDF&message=v6.21.6&logo=cpu&logoColor=white&color=blue)](https://components.espressif.com/components/bblanchon/arduinojson)  
